<template>
    <div>
      ...
      <ul>
        ...
        <li>Es valorarà positivament que facis servir els elements HTML de forma semàntica i respectis la distribució dels elements tal com veus a l'enunciat.</li>
      </ul>
    </div>
</template>